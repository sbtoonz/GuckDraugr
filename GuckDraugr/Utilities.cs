...
namespace GuckDraugr
{
    public static class Utilities
    {
        ...
        {
            var resource = typeof(GuckDraugrMod).Assembly.GetManifestResourceNames().Single
                (s => s.EndsWith(bundleName));
            using var stream = typeof(GuckDraugrMod).Assembly.GetManifestResourceStream(resource);
